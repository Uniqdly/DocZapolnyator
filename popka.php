...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['fio'])) {
        ...
        $sql_check_existence = "SELECT * FROM end WHERE student_fio = '$fio'";
        $result_existence = $conn->query($sql_check_existence);
        ...
        if ($result_existence->num_rows == 0) {
            ...
            // Обновляем данные в таблице 'end'
            // Ваш существующий код обновления данных в таблицу 'end' здесь

            // После обновления всех данных, вы можете вывести сообщение об успешном обновлении
